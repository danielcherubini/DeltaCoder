"""
Download and preprocess Jackrong/Competitive-Programming-python-blend for DeltaCoder Qwen3.5 v1.1.
...
Usage:
    python preprocess_competitive_programming.py [--output-dir qwen3.5/v1.1/data]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Preprocess Competitive-Programming-python-blend for Qwen3.5 v1.1"
    )
    parser.add_argument(
