...
Qwen3.6 v1.0 mix (all coding-focused):
...
Shuffles the result and writes to data/v1.0_sft_train.jsonl.
"""
...
def main():
    output = sys.argv[1] if len(sys.argv) > 1 else "data/v1.0_sft_train.jsonl"
